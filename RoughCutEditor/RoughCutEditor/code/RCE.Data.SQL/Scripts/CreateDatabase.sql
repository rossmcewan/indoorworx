...
CREATE DATABASE [RoughCutEditor] ON  PRIMARY 
( NAME = N'RoughCutEditor', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\RoughCutEditor.mdf' , SIZE = 2304KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'RoughCutEditor_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\RoughCutEditor_log.LDF' , SIZE = 512KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
CREATE TABLE [dbo].[Container](
	...
	[ParentContainerId] [varchar](255) NULL,
...
CREATE TABLE [dbo].[Title](
	[Id] [varchar](255) NOT NULL,
	[TitleTemplateId] [varchar](255) NOT NULL,
