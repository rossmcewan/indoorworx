...
namespace WMFSDKWrapper
{
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IWMOutputMediaProps
    {
        [PreserveSig]
...
InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    public class WMFSDKFunctions
    {
        ...
        [DllImport("WMVCore.dll", EntryPoint = "WMCreateSyncReader", SetLastError = true,
                ...
                CallingConvention = CallingConvention.StdCall)]
        internal static extern WinErrorCode WMCreateSyncReader(IntPtr pUnkCert, WMT_RIGHTS dwRights, [Out, MarshalAs(UnmanagedType.Interface)] out IWMSyncReader ppSyncReader);
    }
}
