...
namespace IndoorWorx.Silverlight.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("IndoorWorx-Silverlight-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/IndoorWorx.Silverlight.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("IndoorWorx-Silverlight-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
